    ...
    SweetAlert.prototype.init = function () {
        ...
        $('#ajax-alert').click(function () {
            swal({
                ...
                confirmButtonClass: 'btn btn-success',
                cancelButtonClass: 'btn btn-danger',
                preConfirm: function (Nama) {
                    return new Promise(function (resolve, reject) {
                        setTimeout(function () {
                            if (Nama === 'taken@example.com') {
                ...
                swal({
                    type: 'success',
                    title: 'Berjaya Sertai Program',
                    html: 'Nama: ' + Nama
                })
            }).catch(swal.noop); // Add a catch to handle cancel button click
        
            // Handle cancel button click
            $('.swal2-cancel').click(function () {
                window.location.href = 'dashboarduser.php'; // Redirect to dashboarduser.php
            });
        });
