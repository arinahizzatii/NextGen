...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>Create Psychometric Test</title>
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
                ...
                <div class="html-editor pd-20 card-box mb-30">
                    <h4 class="h4 text-blue">SOALAN PSIKOMETRIK</h4>

            <form action="admin_create_psikometrik_process.php" method="POST" onsubmit="return showSuccessAlert()">
                <!--CATEGORY FORM-->
                <div class="form-group">
                    <label style="font-size: 12px;color:grey">Soalan:</label>
                    <input name="Soalan_Psikometrik" class="form-control" type="text" placeholder="Masukkan Soalan..." required>
				</div>
