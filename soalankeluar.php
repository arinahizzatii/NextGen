	...
	<div class="header">
		...
		<div class="header-right">
			<div class="dashboard-setting user-notification">
				<div class="dropdown">
					<a class="dropdown-toggle no-arrow" href="javascript:;" data-toggle="right-sidebar"><!--<i class="dw dw-settings2"></i>--></a>
				</div>
			</div>
					...
					<div class="row">
						...
						<div class="pd-20 card-box mb-30">
							...
							<?php
								...
								$queryx = "SELECT * FROM soalan_r where ID_kategori_soalan='$categoryid' AND cin_cout='Akhir'";
							...
							<form action="SoalanProcess.php" method="POST">
									<?php
									// Query for questions
									$query = "SELECT * FROM soalan_r WHERE ID_kategori_soalan = '$categoryid' AND cin_cout = 'Akhir'";
