	...
	<div class="login-header box-shadow">
		<div class="container-fluid d-flex justify-content-between align-items-center">
			...
			<div class="login-menu">
				<ul>
					<li><a href="register.php">Daftar Akaun</a></li>
				</ul>
			</div>
		</div>
	</div>
				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-primary">Log Masuk</h2>
						</div>
						...
						<form action="loginprocess.php" method="post">
							...
							<div class="row pb-30">
								...
								<div class="col-6">
									<div class="forgot-password"><a href="forgot_password.php">Lupa Kata Laluan</a></div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group mb-0">
										<input class="btn btn-primary btn-lg btn-block" type="submit" value="Log Masuk">
									</div>
									<div class="font-16 weight-600 pt-10 pb-10 text-center" data-color="#707373">ATAU</div>
									<div class="input-group mb-0">
										<a class="btn btn-outline-primary btn-lg btn-block" href="register.php">Daftar Akaun</a>
									</div>
								</div>
							</div>
						</form>
